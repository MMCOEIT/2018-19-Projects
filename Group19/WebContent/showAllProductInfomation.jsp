...
<html>
<head>
<title>Mining Algorithm to archive High utility item set using TKO with TKU | Show Books Infomation   </title>
...
<%
ResultSet rs=(ResultSet)session.getAttribute("userShowAllBooksSession");

%>
<%
String userCategory=(String)session.getAttribute("userCategorySession");
%>
		...
		%>
		 <div class="grid1_of_4">
				<div class="content_box"><a href="#">
			   	   	<a href="UserViewProductDetailsController?ProductId=<%=rs.getInt(1)%>"><img src="books/<%=rs.getInt(1) %>.jpg"  alt="No Images " height="200px" width="200px"/></a> 
				   	  </a>
				    <h4><a href="UserViewProductDetailsController?ProductId=<%=rs.getInt(1)%>"> Brands Name : <%=rs.getString(2) %></a></h4>
				    
				      <h4><a href="UserViewProductDetailsController?ProductId=<%=rs.getInt(1)%>"> Product Name  : <%=rs.getString(3) %></a></h4>
				      
				         <h4><a href="UserViewProductDetailsController?ProductId=<%=rs.getInt(1)%>"> Prices  : <%=rs.getString(15) %></a></h4>
				         
				         
				            <h4><a href="UserViewProductDetailsController?ProductId=<%=rs.getInt(1)%>"> SRP  : <%=rs.getString(5) %></a></h4>
				       
				       
				     
					 <div class="grid_1 simpleCart_shelfItem">
				    
					 <div class="item_add"><span class="item_price"><h6> SKU <%=rs.getString(4) %></h6></span></div>
					 
					   <h4><a href="UserViewProductDetailsController?ProductId=<%=rs.getInt(1)%>"> gross weight  : <%=rs.getString(6) %></a></h4>
					   
					  <!--  <div>
						   		<span><input type="submit" class="" value="Submit us"></span>
						  </div> -->
					 
					<%--  <div class="item_add"><span class="item_price"><a href="UserViewProductDetailsController?ProductId=<%=rs.getInt(1)%>">Add to card</a></span></div>  --%>
