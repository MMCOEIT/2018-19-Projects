...
ResultSet rs=(ResultSet)session.getAttribute("ResultFinalTKUBuySession");
...
ResultSet rs1=(ResultSet)session.getAttribute("ResultFinalTKUHitSession");
...
<div class="women_main">
	<!-- start content -->
      ...
      <div class="w_content">
		<div class="women">
			<a href="#"><h4><%=userCategory %> - TKO With TKU  For Hits  <span></span> </h4></a>
		...
		%>
		 <div class="grid1_of_4">
				<%-- <div class="content_box"><a href="#">
			   	   	<a href=""><img src="books/<%=rs1.getInt(2) %>.jpg"  alt="No Images " height="200px" width="200px"/></a> 
				   	  </a>
				    <h4><a href="UserViewProductDetailsController?book_id=<%=rs1.getInt(2)%>"> <%=rs1.getString(4) %></a></h4>
				    
				      <h4><a href="UserViewProductDetailsController?book_id=<%=rs1.getInt(2)%>"> <%=rs1.getString(3) %></a></h4>
				     
					 <div class="grid_1 simpleCart_shelfItem">
				    
					 <div class="item_add"><span class="item_price"><h6><%=rs1.getString(5)%></h6></span></div>
				    ...
				    <h4> Product Name  <a href="UserViewProductDetailsController?book_id=<%=rs1.getInt(2)%>"> <%=rs1.getString(4) %></a></h4>
				    
				       <h4>Product Brand name  <a href="UserViewProductDetailsController?book_id=<%=rs1.getInt(2)%>"> <%=rs1.getString(3) %></a></h4>
				     
				<h4> Product SRP <a href="#" ><%=rs1.getString(5)%> 	</a>  </h4>
				
				<h4> Product SKU <%=rs1.getString(6)%> </h4>	 
				    
					<h4> Product Gross Weight <%=rs1.getString(7) %> </h4> 
				
					<h4> Product Net Weight	 <%=rs1.getString(8) %> </h4> 
					
					<h4> Product recyclable_package	 <%=rs1.getString(9)%> </h4> 
					
						<h4> Product Low Fat 	 <%=rs1.getString(10)%> </h4> 
						
						<h4> Product Unit Per 	 <%=rs1.getString(11)%> </h4> 
						
						<h4> Product Cases per 	 <%=rs1.getString(12)%> </h4>
						
						<h4> Product Height  	 <%=rs1.getString(13)%> </h4>
						
						<h4> Product width 	 <%=rs1.getString(14)%> </h4>
						
						<h4> Product Depth 	 <%=rs1.getString(15)%> </h4>
						
							<h4> Product Prices 	 <%=rs1.getString(16)%> </h4>
