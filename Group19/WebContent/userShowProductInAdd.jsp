...
<html>
<head>
<title>Mining Algorithm to archive High utility item set using TKO with TKU | Check Out Page  </title>
...
count=(Integer)session.getAttribute("userCountSessionInfomation");

%>

<%
ResultSet rs=(ResultSet)session.getAttribute("BooksSessionInfomation");
...
<div class="women_main">
	...
	<div class="check">	 
			 ...
			 <a class="continue" href="UserContinueToBasketController">Continue to basket</a>
			 <div class="price-details">
				 <h3>Price Details</h3>
				 <span>Total</span>
				 <%while(rs.next())
					 {
				//id, user_id, user_email, user_fname, book_id, book_title, book_price, book_author, book_category, product_price
					 %>
				 <span class="total1"><%=rs.getString(10) %></span>
				<div class="clearfix"></div>				 
			 </div>	
			 <ul class="total_price">
			   <li class="last_price"> <h4>TOTAL</h4></li>	
			   <li class="last_price"><span><%=rs.getString(10) %></span></li>
			   
			 </ul>
		
			 
			  <div class="clearfix"></div>
			  <a class="order" href="UserProductOrderController?bookId=<%=rs.getInt(5)%>&userId=<%=rs.getInt(2)%>&bookCategory=<%=rs.getString(9)%>">Place Order</a> 
		 ...
		 <div class="col-md-9 cart-items">
			 ...
			 <div class="cart-header">
				 ...
				 <div class="cart-sec simpleCart_shelfItem">
						...
						// //id, user_id, user_email, user_fname, book_id, book_title, book_price, book_author, book_category
						%>
							 <img src="books/<%=rs.getInt(5) %>.jpg"  class="img-responsive" alt="">
						</div>
					   <div class="cart-item-info">
						<h3><a href="#"><%=rs.getString(6) %></a>
