...
<html>
<head>
<title>Mining Algorithm to archive High utility item set using TKO with TKU | User Search Book   </title>
...
<body>
 ...
 <div class="women_main"> 
					 ...
					 -->
						...
						<div class="forms">
							<div class="inline-form widget-shadow">
								...
								<div class="form-body">
									<form class="form-inline" action="UserSearchProductController">
    <div class="form-group">
      <label class="col-md-1 control-label" for="lunch">BrandName</label>
    </div>
    <div class="form-group">
      <select id="lunch" class="selectpicker" data-live-search="true" title="Please select a Brands Name  ..." name="user_book_category" required="required">
      ...
      %>
        ...
        <div class="form-group">
      <label class="col-md-1 control-label" for="lunch">Parametre:</label>
    </div>
       <select id="lunch" class="selectpicker" data-live-search="true" title="Please select a Parametre ..." name="user_parametre" required="required">
       ...
       <div class="form-group">
      <label class="col-md-1 control-label" for="lunch">Algorithms :</label>
    </div>
      
       <select id="lunch" class="selectpicker" data-live-search="true" title="Please select a Algorithms  ..." name="user_Algorithms" required="required">
        ...
        <option value="TKU">TKU </option>
          ...
          <option value="main">Main Algorithms  </option>
    ...
    <label>Top K Value</label> <input type="text" class="form-control" name="user_Top_k_value"  placeholder="Top K Value " pattern="[0-9]{0-4}" required="required"> 
