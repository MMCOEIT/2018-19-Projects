...
public class TKO_Algorithms_MainMethods {
	...
	// for statistics
		...
		int minsuppRelative=1;   // minimum support threshold that will be raised dynamically
		 ...
		 * Default constructor
		 */
		public TKO_Algorithms_MainMethods() {}
...
//			System.out.println("Candidates count : " + candidates.size());
		...
		public String RunMethods(String Result)
		{
		
			String finalResult=null; 
			
			System.out.println("In run methods is "+Result);
			
			TKO_Algorithms tkoObject=new TKO_Algorithms();
			
			 finalResult=tkoObject.all_result(Result);
