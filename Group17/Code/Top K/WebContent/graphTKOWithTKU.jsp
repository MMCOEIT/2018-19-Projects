...
<html>
	...
	<head>
		...
		<title>Graphs - TKO with TKU  Time Graph</title>
...
rs=(ResultSet)session.getAttribute("ResultTKUSession");
...
//id, user_Category, user_ToK, user_MainTime
<% while(rs.next()){%>
				...
				.highcharts(
						{
							...
							title : {
								text : 'Top K with TKO With TKU Algorithms '
							},
