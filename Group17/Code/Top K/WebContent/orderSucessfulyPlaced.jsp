...
-->
<!DOCTYPE HTML>
<%@page import="com.project.beans.BookBeans"%>
<%@page import="java.sql.ResultSet"%>
<%@page import="com.project.beans.UserBeans"%>
<html>
<head>
<title>Mining Algorithm to archive High utility item set using TKO with TKU | Book successfully placed   </title>
...
bookBeans =(BookBeans)session.getAttribute("bookBeansSession");
	...
	<div class="row single">
				<div class="det">
				  <div class="single_left">
					<div class="grid images_3_of_2">
						<div class="flexslider">
						  ...
						  <div class="flex-viewport" style="overflow: hidden; position: relative;"><ul class="slides" style="width: 1200%; transition-duration: 0.6s; transform: translate3d(-864px, 0px, 0px);"><li data-thumb="books/<%=bookBeans.getBook_id() %>.jpg" class="clone" aria-hidden="true" style="width: 288px; float: left; display: block;">
								   <div class="thumb-image"> <img src="books/<%=bookBeans.getBook_id() %>.jpg" data-imagezoom="true" class="img-responsive" draggable="false"> </div>
								</li>
				  ...
				  <div class="desc1 span_3_of_2">
					<h3><%=bookBeans.getBrand_name() %></h3>
					<span class="brand">Author : <a href="#"><%=bookBeans.getProduct_name() %> </a></span>
					<br>
					<span class="code">Product Prices: <%=bookBeans.getShelf_depth() %></span>
					
						<div class="price">
							<span class="text">Price:</span>
							<span class="price-new">$<%=bookBeans.getSKU() %></span> 
							
						</div>
						<div class="btn_form">
						 <a href="userSelectProductByCategoryController">Continue Shopping </a> 
					</div>
