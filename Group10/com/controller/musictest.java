...
/**
 * Servlet implementation class musictest
 */
@WebServlet("/musictest")
...
//id, cid, username, password, email, cpassword, testresult		
		...
		finally 
		{
			...
			if(count==4||count==5)
			{
			    ...
			    response.sendRedirect("ExpertConform.jsp?message=Congratulations...You did it! So proud of you!!!!Welcome To Music Expert Team!!!");
