...
public class SpellCheckerApplication {
	...
	public static void main(String[] args) {
		...
		MySpellChecker spellChecker = new MySpellChecker("A://Project_2017//RING//QA_iASK//my_dictionary.txt");
...
public static String spellCheck(String line) {
		...
		// You can change your file path accordingly.
		MySpellChecker spellChecker = new MySpellChecker("A:\\twitter\\QA_iASK\\my_dictionary.txt");
