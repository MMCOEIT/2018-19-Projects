		...
		%>
		 <div class="grid1_of_4">
				<div class="content_box"><a href="#">
				    ...
				    <h4><a href="UserViewBookDetailsController?book_id=<%=rs.getInt(2)%>"> <%=rs.getString(4) %></a></h4>
				    
				      <h4><a href="UserViewBookDetailsController?book_id=<%=rs.getInt(2)%>"> <%=rs.getString(3) %></a></h4>
		...
		%>
		 <div class="grid1_of_4">
				<div class="content_box"><a href="#">
				    ...
				    <h4><a href="UserViewBookDetailsController?book_id=<%=rs1.getInt(2)%>"> <%=rs1.getString(4) %></a></h4>
				    
				      <h4><a href="UserViewBookDetailsController?book_id=<%=rs1.getInt(2)%>"> <%=rs1.getString(3) %></a></h4>
