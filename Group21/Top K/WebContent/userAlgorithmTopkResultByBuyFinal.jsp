...
<div class="women_main">
   ...
   <div class="w_content">
		<div class="women">
			<a href="#"><h4><%=userCategory %> TKO With TKU  for Buy  - <span></span> </h4></a>
		...
		%>
		 <div class="grid1_of_4">
				<div class="content_box"><a href="#">
			   	   	<a href=""><img src="books/<%=rs.getInt(2) %>.jpg"  alt="No Images " height="200px" width="200px"/></a> 
				   	  </a>
				    <h4> Product Name  <a href="UserViewProductDetailsController?book_id=<%=rs.getInt(2)%>"> <%=rs.getString(4) %></a></h4>
				    
				       <h4>Product Brand name  <a href="UserViewProductDetailsController?book_id=<%=rs.getInt(2)%>"> <%=rs.getString(3) %></a></h4>
				     
				<h4> Product SRP <a href="#" ><%=rs.getString(5)%> 	</a>  </h4>
				
				<h4> Product SKU <%=rs.getString(6)%> </h4>	 
				    
					<h4> Product Gross Weight <%=rs.getString(7) %> </h4> 
				
					<h4> Product Net Weight	 <%=rs.getString(8) %> </h4> 
					
					<h4> Product recyclable_package	 <%=rs.getString(9)%> </h4> 
					
						<h4> Product Low Fat 	 <%=rs.getString(10)%> </h4> 
						
						<h4> Product Unit Per 	 <%=rs.getString(11)%> </h4> 
						
						<h4> Product Cases per 	 <%=rs.getString(12)%> </h4>
						
						<h4> Product Height  	 <%=rs.getString(13)%> </h4>
						
						<h4> Product width 	 <%=rs.getString(14)%> </h4>
						
						<h4> Product Depth 	 <%=rs.getString(15)%> </h4>
						
							<h4> Product Prices 	 <%=rs.getString(16)%> </h4>
