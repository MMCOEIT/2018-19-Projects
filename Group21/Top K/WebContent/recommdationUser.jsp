...
ResultSet rs=(ResultSet)session.getAttribute("recommdationProductSession");
...
<div class="women_main">
	<!-- start content -->
	<div class="grids">
					<img src="images/bookImages.PNG" width="989px" height="1000px">
				</div>
		...
		%>
		 <div class="grid1_of_4">
				<div class="content_box"><a href="#">
			   	   	<a href="UserViewBookDetailsController?book_id=<%=rs.getInt(2)%>"><img src="books/<%=rs.getInt(2) %>.jpg"  alt="No Images " height="200px" width="200px"/></a> 
				   	  </a>
				    <h4><a href="UserViewBookDetailsController?book_id=<%=rs.getInt(2)%>"> Book Name : <%=rs.getString(3) %></a></h4>
				    
				      <h4><a href="UserViewBookDetailsController?book_id=<%=rs.getInt(2)%>"> Book Author : <%=rs.getString(4) %></a></h4>
					 ...
					 <div class="item_add"><span class="item_price"><h6> Book Prices <%=rs.getString(5) %></h6></span></div>
                           ...
                           <div class="menu">
									<ul id="menu" >
										...
										<li><a href="UserViewProfileController?userId=<%=userId%>"><i class="fa fa-tachometer"></i> <span><%=userName %></span></a></li>
										 <li id="menu-academico" ><a href="#"><i class="fa fa-table"></i> <span>Select Books </span> <span class="fa fa-angle-right" style="float: right"></span></a>
										   <ul id="menu-academico-sub" >
										   
											<li id="menu-academico-avaliacoes" ><a href="userSelectBookByCategoryController">By Category </a></li>
											
																					
										  </ul>
										</li>
										
										<li><a href="UserSelectBookForSearchingController"><i class="fa fa-tachometer"></i> <span>Search Book </span></a></li>
