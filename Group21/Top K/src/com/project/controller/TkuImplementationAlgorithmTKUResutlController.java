...
/**
 * Servlet implementation class TkuImplementationAlgorithmTKUResutlController
 */
@WebServlet("/TkuImplementationAlgorithmTKUResutlController")
public class TkuImplementationAlgorithmTKUResutlController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public TkuImplementationAlgorithmTKUResutlController() {
        super();
		...
		sessionF.setAttribute("finalTime1Session",timeFinal1);
				...
				try {
					...
					if(userSearchBookBeans.getUser_paramertre().equals("Hit")){
						...
						System.out.println("In TKU Values ...");
						
                         int n=userDao.userTKUResultGrpah(userSearchBookBeans.getUser_category(), userSearchBookBeans.getUser_top_k_value(), totalTKU);
