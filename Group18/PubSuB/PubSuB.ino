...
if(client.connect("clientId-nY90jCVw7u"))
{
Serial.println("Connected");
client.publish("testtopic/temp","Connected!");
client.subscribe("testtopic/led");
...
Serial.println(tmp);
client.publish("testtopic/temp",pub_str);
delay(1000);
